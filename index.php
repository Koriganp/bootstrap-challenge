...
<html lang="en-US">
	<head>
		...
		<meta name="description" content="Bootstrap Challenge"/>
	...
	<body>
		<nav class="navbar navbar-default navbar-expand-md navbar-light bg-light text-secondary rounded border border-dark m-4" role="navigation">
		...
		<header class="m-4">
			<div class="jumbotron">
				<h1 class="display-3">No pressure.</h1>
				<p class="lead">Just pretend you are a whisper floating across a mountain. There isn't a rule. You just practice and find out which way works best for you. Now, we're going to fluff this cloud. Only think about one thing at a time. Don't get greedy.</p>
				<p class="lead">
					<a class="btn btn-primary btn-lg" href="#" role="button">Paint</a>
				</p>
			</div>
		</header>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-lg-3">
						<img class="mw-100 mt-4" src="images/rattlesnake.jpg" alt="Image of a rattlesnake"/>
					</div>
